                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('UNAMBA')}</span>
                        </NavLink>
                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                                        ...
                                        <li className="menu nav-item">
                                            ...
                                            <AnimateHeight duration={300} height={currentMenu === 'steps' ? 'auto' : 0}>
                                                <ul className="sub-menu text-gray-500">
                                                    {/* Paso 1 */}
                                                    <li className="nav-item">
                                                        <NavLink to="/apps/paso/reservacion-titulo" className="group">
                                                            <div className="flex items-center">
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'auth' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/auth/inicio-sesion" target="_blank">
                                                {t('login_boxed')}
                                            </NavLink>
                                        </li>
                                        <li>
